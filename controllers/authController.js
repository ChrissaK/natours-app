...
const createSendToken = (user, statusCode, res) => {
  ...
  // Remove password from output when creating document
...
exports.protect = catchAsync(async (req, res, next) => {
  ...
  // Store user object inside the request object so that subsequent middlewares can have access to user data (eg. user role)
